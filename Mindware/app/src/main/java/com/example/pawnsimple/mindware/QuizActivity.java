package com.example.pawnsimple.mindware;
...
public class QuizActivity extends AppCompatActivity {
    ...
    List<Questao> questoes = new ArrayList<Questao>(){
        {
            add(new Questao("O que é o FACS?", R.id.rbResposta1, "Facial Action Coding System", "Um método de descrição do movimento facial", "Um Mito", "Sigla Psicologia"));
            add(new Questao("Quem foi o primeiro a estudar as expressões faciais?", R.id.rbResposta2, "Darwin", "Jesus", "Colombo", "Paul Ekman"));
        }
    };
